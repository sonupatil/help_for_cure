<jsp:include page="../../header.jsp"></jsp:include>
    ...
    <!-- Services Section -->
			...
			<div class="form-group">
			  <label class="col-md-4 control-label" for="textinput">Medical Registration Number</label>  
			  <div class="col-md-4">
			  <input id="textinput" name="textinput" type="text" placeholder="Registration Number" class="form-control input-md" required="">
